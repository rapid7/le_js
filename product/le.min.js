...
k=(r?"https://":"http://")+k+"/logs/"+e;var h=[],l=!1,t=!1;if(a.catchall){var u=b.onerror;b.onerror=function(a,b,d){m({error:a,line:d,location:b}).level("ERROR").send();return u?u(a,b,d):!1}}var p=function(){var a=b.navigator||{doNotTrack:void 0},c=b.screen||{};return{url:(b.location||{}).pathname,referrer:document.referrer,screen:{width:c.width,height:c.height},window:{width:b.innerWidth,height:b.innerHeight},browser:{user_agent:a.userAgent,cookie_enabled:a.cookieEnabled,do_not_track:a.doNotTrack||
b.doNotTrack||a.msDoNotTrack},platform:a.platform}},v=function(){var a=null,a=Array.prototype.slice.call(arguments);if(0===a.length)throw Error("No arguments!");return a=1===a.length?a[0]:a},m=function(a){var b=v.apply(this,arguments),d={event:b};"never"===q||t&&"per-entry"!==q||(t=!0,"undefined"===typeof b.screen&&"undefined"===typeof b.browser&&m(p()).level("PAGE").send());c&&(d.trace=c);return{level:function(a){if(g&&"undefined"!==typeof console&&"PAGE"!==a){var b=null;"undefined"!==typeof XDomainRequest&&
