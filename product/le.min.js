...
a=1===a.length?a[0]:m(a).join(" ");a={event:a};if("never"!==g&&("per-entry"===g||!p)){var c=f.screen||{width:"unknown",height:"unknown"};a.agent={name:(f.navigator||{userAgent:"unknown"}).userAgent,screenWidth:c.width,screenHeight:c.height};p=!0}t&&(a.trace=d);a=JSON.stringify(m(a));l?k.push(a):s(n,a)};this.log=r;var s=function(b,a){l=!0;var c=function(){f.ActiveXObject&&(f.XMLHttpRequest=function(){return new ActiveXObject("Microsoft.XMLHTTP")});return new XMLHttpRequest}();c.onreadystatechange=
function(){4===c.readyState&&(400<=c.status?(console.error("Couldn't submit events."),410===c.status&&console.warn("This version of le_js is no longer supported!")):(301===c.status&&console.warn("This version of le_js is deprecated! Consider upgrading."),0<k.length?s(b,k.shift()):l=!1))};c.open("POST",(h?"https://":"http://")+"js.logentries.com/v1/v1/logs/"+n,!0);c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Content-type","text/json");c.send(a)}}var g;return{init:function(e){var d=
{ssl:!0};if("object"===typeof e)for(var f in e)d[f]=e[f];else"string"===typeof e&&(d.token=e);d.catchall=d.catchall||!1;d.trace=d.trace||!1;d.page_info=d.page_info||"never";if(void 0===d.token)throw Error("Token not present.");g=new h(d);return!0},log:function(){if(g)g.log.apply(this,arguments);else throw Error("You must call LE.init(...) first.");}}}(this);