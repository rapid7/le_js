...
function(){4===c.readyState&&(400<=c.status?console.warn("Couldn't submit events."):0<k.length?s(b,k.shift()):l=!1)};c.open("POST",(h?"https://":"http://")+"js.logentries.com/logs/"+n,!0);c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Content-type","text/json");c.send(a)}}var g;return{init:function(e){var d={ssl:!0};if("object"===typeof e)for(var f in e)d[f]=e[f];else"string"===typeof e&&(d.token=e);d.catchall=d.catchall||!1;d.trace=d.trace||!1;d.page_info=d.page_info||
