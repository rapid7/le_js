...
void 0===a[b]?c.push("undefined"):c.push(a[b]);a=c.join(" ")}a=[a];"never"!==h&&("per-entry"===h?a.unshift(t()):q||(a.unshift(t()),q=!0));w&&a.unshift({tracecode:d});a=k(a,"",!1);n?m.push(a):v(p,a)};this.log=s;var v=function(b,a){n=!0;var c=function(){f.ActiveXObject&&(f.XMLHttpRequest=function(){return new ActiveXObject("Microsoft.XMLHTTP")});return new XMLHttpRequest}();c.onreadystatechange=function(){4===c.readyState&&(400<=c.status?console.warn("Couldn't submit events."):0<m.length?v(b,m.shift()):
n=!1)};c.open("POST",(l?"https://":"http://")+"js.logentries.com/logs/"+p,!0);c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Content-type","application/x-www-form-urlencoded");c.send(a)}}var h;return{init:function(b){var d={ssl:!0};if("object"===typeof b)for(var f in b)d[f]=b[f];else"string"===typeof b&&(d.token=b);d.catchall=d.catchall||!1;d.trace=d.trace||!1;d.page_info=d.page_info||"never";if(void 0===d.token)throw Error("Token not present.");h=new l(d);return!0},log:function(){if(h)h.log.apply(this,
arguments);else throw Error("You must call LE.init(...) first.");}}}(this);