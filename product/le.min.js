...
function(){4===c.readyState&&(400<=c.status?(console.error("Couldn't submit events."),410===c.status&&console.warn("This version of le_js is no longer supported!")):(301===c.status&&console.warn("This version of le_js is deprecated! Consider upgrading."),0<k.length?s(b,k.shift()):l=!1))};c.open("POST",(h?"https://":"http://")+"js.logentries.com/v1/logs/"+n,!0);c.setRequestHeader("X-Requested-With","XMLHttpRequest");c.setRequestHeader("Content-type","text/json");c.send(a)}}var g;return{init:function(e){var d=
