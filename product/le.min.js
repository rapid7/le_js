...
*/
'use strict';var LE=function(d){function k(b){var e=(Math.random()+Math.PI).toString(36).substring(2,10),g=b.trace,f=b.page_info,p=b.token,k=b.print,u=b.ssl,l=[],m=!1,q=!1;if(b.catchall){var r=d.onerror;d.onerror=function(a,c,h){s({error:a,line:h,url:c}).level("ERROR").send();return r?r(a,c,h):!0}}var v=function(){var a=document.cookie.split("; "),c=null,h;for(h in a){var b=a[h].split("\x3d");if("__le_trace"===b[0]&&2===b.length){c=b[1];break}}(a=c)||(a=new Date,a.setFullYear(2100),a="__le_trace\x3d"+
